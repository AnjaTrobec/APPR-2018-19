...
poroceni.zasavska <- read_csv2("podatki/poroceni-zasavska.csv",skip=5, col_names = c("starostni.tip", paste0("", 2011:2018)), locale = locale(decimal_mark = ",", grouping_mark = "."))
poroceni.zasavska$regija <- c("Zasavska")
poroceni.savinjska <- read_csv2("podatki/poroceni-savinjska.csv", skip=5, col_names = c("starostni.tip", paste0("", 2011:2018)), locale = locale(decimal_mark = ",", grouping_mark = "."))
poroceni.savinjska$regija <- c("Savinjska")
poroceni.posavska <- read_csv2("podatki/poroceni-posavska.csv", skip=5, col_names = c("starostni.tip", paste0("", 2011:2018)), locale = locale(decimal_mark = ",", grouping_mark = "."))
...
poroceni.podravska <- read_csv2("podatki/poroceni-podravska.csv", skip=5, col_names = c("starostni.tip", paste0("", 2011:2018)), locale = locale(decimal_mark = ",", grouping_mark = "."))
