...
```{r zemljevid, echo=FALSE, fig.align='left', warning=FALSE, error=FALSE, message=FALSE, results='hide'}
print(zemljevid)
```
...
shinyAppDir("shiny", options=list(width="100%", height=250000))
```


# Zaključek

Delo v R-u je bil zame izziv, ampak mi je delo olajšala zanimiva tema. Potrdila sem svoje hipoteze in dodatno ugotovila, da je ločitev veliko več kot bi si želeli in da so nažalost v večini primerov žrtve teh tudi otroci. Najbolj zabaven del naloge pa je bil izdelovanje aplikacije Shiny, ki je bil hkrati tudi največji izziv.
