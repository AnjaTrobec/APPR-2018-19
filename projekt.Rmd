...
```{r zemljevid, echo=FALSE, fig.align='left', warning=FALSE, error=FALSE, message=FALSE}
source("vizualizacija/mojavizualizacija.R", encoding="UTF-8")
print(zemljevid)
```
...
print(graf5)
```
Zgornji graf prikazuje napoved o številu porok med letoma 1998 - 2030. Kot vidimo število porok občutno pada, kar potrdi mojo hipotezo. Ljudje se poročajo vedno kasneje in število porok pada.
